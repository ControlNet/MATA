...
class Florence2(BaseModel):
    ...
    def __init__(self, gpu_number=0):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(self.model_name, dtype=self.torch_dtype, trust_remote_code=True).to(self.device)
    ...
    def prepare(cls):
        """Download the model"""
        AutoModelForCausalLM.from_pretrained(cls.model_name, dtype=torch.float32, trust_remote_code=True)
